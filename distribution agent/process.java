...
class process extends JFrame
{
	...
	public process(String name,int port)throws Exception
	{
		...
		this.setTitle("Distribution agent processing window---->"+name );
		con.setBackground(new Color(21,170,50));
		
		
		title=new JLabel(name +"  ===>DISTRIBUTION AGENT PROCESSING DETAILS");
		title.setFont(new Font("Bookman Old Style",Font.BOLD,12));
		...
		con.add(title);
			...
			jta1=new JTextArea();
			jta1.setFont(new Font("Book Man Old",2,17));
        	jta1.setForeground( Color.BLACK);
        	jta1.setBackground (Color.white);
			jsp1=new JScrollPane(jta1);
//			jta1.setFont()
			jsp1.setBounds(35,50,335,400);
			jsp1.setBorder(BorderFactory.createLineBorder(Color.red,5));
		//	jsp1.setVisible(false);
			jta1.setEditable(false);
			jta1.append(name  +"Main Server is Started........\n");
		con.add(jsp1);
